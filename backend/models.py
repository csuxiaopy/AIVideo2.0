...
class Camera(Base):
    ...
    frame_interval_seconds: Mapped[int] = mapped_column(Integer, default=60, nullable=False)
...
class DetectorSettings(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, default=1)
    general_model: Mapped[str] = mapped_column(String(300), default="models/yolo26s.pt")
